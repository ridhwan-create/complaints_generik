    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="{{ route('public_complaints.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select id="system" name="system" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
            ...
            <div class="mt-6 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                ...
                <!-- Back Button -->
                <button type="button" onclick="window.history.back()" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded w-full md:w-auto">
                    {{ __('Back') }}
                </button>
            </div>
        </form>
