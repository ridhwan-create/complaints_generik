            ...
            <div class="fixed top-0 right-0 p-4 text-right z-10 sm:p-6">
                @auth
                    <a href="{{ url('/dashboard') }}" 
                       class="text-sm font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:rounded-sm">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" 
                       class="ml-4 text-sm font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:rounded-sm">
                        Login
                    </a>
                @endauth
            </div>
